...
if (create_slots)
{
	if (array_length(global.invSlots) < global.invSize)
	{
		for (var i=0; i<global.invSize; i++)
		{
			...
			else if (i < 13){var _x = 100+((i-8)*32); var _y = 100+64}
			else if (i < 18){var _x = 100+((i-13)*32); var _y = 100+128}
			else if (i < 23){var _x = 100+((i-18)*32); var _y = 228+64}
