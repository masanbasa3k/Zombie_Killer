...
draw_healthbar(32,96,128,100,_player_healtPC,c_gray,c_red,c_red,0,true,true);

var _player_staminaPC = (global.player_stamina / global.player_stamina_max) * 100;
draw_healthbar(32,112,128,116,_player_staminaPC,c_gray,c_orange,c_orange,0,true,true);
