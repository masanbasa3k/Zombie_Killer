...
function scr_enemy_tile_collision(){
	...
	// Horizontal Entities
	var _entityCount = instance_position_list(x+hSpeed,y,par_entity,_entityList,false)-1;
	var _snapX;
	...
	// Vertical Entities
	var _entityCount = instance_position_list(x,y+vSpeed,par_entity,_entityList,false)-1;
	var _snapY;
	while (_entityCount > 0)
	{
		var _entityCheck = _entityList[| 0];
